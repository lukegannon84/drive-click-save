...
<div class="colmask threecol">
	<div class="colmid">
		...
		$result = mysql_query("SELECT DISTINCT registration,start_mileage,date from users where company='$company';") 
		or die(mysql_error());  
		?><table class="imagetable">
<?php
		
		echo "<tr> <th>Registration</th> <th>Start Mileage</th><th>Date</th> </tr>";
		...
		$reverseDate = date("d-m-Y", strtotime($dateFromDatabase));
			...
			echo "</td><td>"; 
			echo "<a href='fill.php?start_mileage=$start_mileage' style='text-decoration:none;color:black'>$start_mileage </a>";
			echo "</td><td>"; 
			echo "<a href='fill.php?date=$date' style='text-decoration:none;color:black'>$reverseDate </a>";
			}		
		}
?></table>
				<!-- center Column 1 end -->
